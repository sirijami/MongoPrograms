...
public class minMaxTuple implements Writable {
	...
	private float max_stock_price_adg_close = 0;
	...
	public float getMax_stock_price_adg_close(){
		return max_stock_price_adg_close;
	}
	
	public void setMax_stock_price_adg_close(float max_stock_price_adg_close){
	...
	public void readFields(DataInput in) throws IOException {
		...
		max_stock_price_adg_close = in.readFloat();		
	}
	...
	public void write(DataOutput out) throws IOException {
		...
		out.writeFloat(max_stock_price_adg_close);	
	}
